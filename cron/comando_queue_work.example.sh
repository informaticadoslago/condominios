...
PHP=/usr/bin/php8.3
ART=/var/www/doslagomusica/artisan
LOGS=/var/www/doslagomusica/storage/logs
...
$PHP $ART queue:work --rest=2 --stop-when-empty --tries=2 --queue=EnviarCorreo >> $LOGS/queue_correo 2>&1 &
