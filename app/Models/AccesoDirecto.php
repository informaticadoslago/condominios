...
class AccesoDirecto extends Model
{
    ...
    /** Ficha de entrada a un horario. */
    public const TIPO_HORARIO = 'horario';

    /** Fichas de entrada (comunidad, empresa contable u horario), las que van con color propio. */
    public function scopeFichas($query)
    {
        return $query->whereIn('tipo', [self::TIPO_COMUNIDAD, self::TIPO_EMPRESA_CONTABLE, self::TIPO_HORARIO]);
    }
