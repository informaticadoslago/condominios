...
use App\Livewire\ProyectosContables\Lista as ProyectosContablesLista;
...
Route::middleware([
    ...
    Route::middleware('comunidad.activa')->group(function () {
        ...
        Route::get('/actividades', ActividadesLista::class)->name('actividades.index');
    ...
    Route::middleware('empresa-contable.activa')->group(function () {
        ...
        Route::get('/proyectos-contables', ProyectosContablesLista::class)->name('proyectos-contables.index');
