<x-dosl.dialog-modal wire:model.live="abrirEditar" class="backdrop-blur">
    ...
    <x-slot name="content">        
        ...
        <div class="flex mb-1 w-xl">
            <div class="mt-4 w-full">
                <x-label for="input-editar-permiso" :value="__('Permiso')" />
                <x-input id="input-editar-permiso" class="block mt-1 w-full" type="text" name="nombre" 
