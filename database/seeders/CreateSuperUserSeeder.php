...
class CreateSuperUserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $user->syncRoles([config('doslago.superadmin.nombre_rol'), 'user', 'global-comunidad', 'global-contabilidad', 'global-horario']);
        ...
        $user->syncRoles([$superadmin_rol_name, 'user', 'global-comunidad', 'global-contabilidad', 'global-horario']);
