...
return new class extends Migration
{
    ...
    {
        // Sociedades reutiliza proveedores (persona_type/persona_id polimórfico) en vez de
        // tener su propio catálogo; esta tabla no llegó a usarse desde ningún Livewire.
